...
const Navbar = () => {
  ...
  return (
    <nav
      id="main-navbar"
      className="w-full bg-white z-50 transition-all duration-300 ease-in-out transform  px-4 sm:px-6 lg:px-8 2xl:px-12"
    >
      <div className="max-w-[1024px] xl:max-w-[1400px] 2xl:max-w-[1920px]  px-4 sm:px-6 lg:px-8 mx-auto lg:py-4 border border-gray-300 rounded-2xl mt-2">
