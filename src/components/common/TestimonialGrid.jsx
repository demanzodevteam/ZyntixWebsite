...
const testimonials = [
  ...
  {
    username: "Suryakant Arora",
    text: "​I had an incredible experience working with Crezeal Technologies. Their expertise in web development is unmatched.The team is professional, highly skilled, and always ready to go the extra mile to ensure client satisfaction. Communication was seamless throughout the project, and they completed everything on time and within budget. I highly recommend ​Crezeal Technologies to anyone looking for top-notch web development ​. Thank you for your amazing work! 👏✨",
    stars: 5,
  },
  {
    username: "Godson Chinnu",
  ...
  {
    username: "Print Cord",
    text: "I recently had the pleasure of working with Crezeal Technologies to develop my website, PrintCord.in, and I couldn’t be happier with the results! Crezeal Technologies impressed me from the start with their professionalism, technical expertise, and dedication to bringing my vision to life. The site is not only visually appealing but also highly functional and optimized for both desktop and mobile. I highly recommend Crezeal Technologies to anyone looking for a reliable, innovative web development partner!",
    stars: 5,
  },
  {
  ...
  },
  {
    ...
    text: "One of the best and finest digital marketing company around Nagercoil. Crezeal team provide valuable services for the payment we provided. Thank Benuja and team for the great service. Thank you",
    stars: 5,
  },
  {
    username: "Rajasozhaperumal G",
