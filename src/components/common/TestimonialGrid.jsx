...
const testimonials = [
  ...
  {
    username: "Shanu J",
    text: "Zyntics is the best web designing company. I absolutely loved working with the team in creating a unique website for my Bakery. They brought so many great ideas and design with user experience points to the table and was able to construct what our vision was for our businesses into a stunning website!!I highly recommend Zyntics. If you are looking for a affordable professional service this is the best around Nagercoil!!!",
    stars: 5,
  },
  {
    username: "Suryakant Arora",
    text: "​I had an incredible experience working with Zyntics. Their expertise in web development is unmatched.The team is professional, highly skilled, and always ready to go the extra mile to ensure client satisfaction. Communication was seamless throughout the project, and they completed everything on time and within budget. I highly recommend ​Zyntics to anyone looking for top-notch web development ​. Thank you for your amazing work! 👏✨",
    stars: 5,
  },
  {
    username: "Godson Chinnu",
    text: "Working with Zyntics has been a game-changer for our business. Our business was doing well with offline but we felt that its time to build online. We approached Zyntics, Jushwanth guided us with the plans. They have build me a beautiful website. Their team has significantly boosted our brand visibility. The best part is that I am receiving a couple of calls every week from new customers. Thanks team.",
    stars: 5,
  },
  {
    username: "Print Cord",
    text: "I recently had the pleasure of working with Zyntics to develop my website, PrintCord.in, and I couldn’t be happier with the results! Zyntics impressed me from the start with their professionalism, technical expertise, and dedication to bringing my vision to life. The site is not only visually appealing but also highly functional and optimized for both desktop and mobile. I highly recommend Zyntics to anyone looking for a reliable, innovative web development partner!",
    stars: 5,
  },
  {
    username: "A One Photography",
    text: "Good digital marketing and website development company in Nagercoil. Very polite customer support. Highly recommended",
    stars: 5,
  },
  {
    username: "Aiswerya Kailash",
    text: "Got a chance to work along with them, it was a great experience. Probably one of the best digital marketing company to level up your business.",
    stars: 5,
  },
  {
    username: "Sree Ganapathy",
    text: "I recently had an amazing experience with Zyntics for website design & digital marketing. Their service truly impressed me simply because they attentively & patiently listened to our lengthy brief. And everything worked successfully and now we receive enquiries regularly. Highly recommended.",
    stars: 5,
  },
  {
    username: "Krishna Moorthy",
    text: "I recently worked with Zyntics for our website development and am very happy with the results. Special thanks to Jushwanth for his excellent support. I highly recommend Zyntics for website development 👌👌",
    stars: 5,
  },
  {
    username: "Crest Ronics",
    text: "One of the best and finest digital marketing company around Nagercoil. Zyntics team provide valuable services for the payment we provided. Thank Jushwanth and team for the great service. Thank you",
    stars: 5,
  },
  {
    username: "Rajasozhaperumal G",
    text: "So lucky to have found Jushwanth! He explained the services so I could understand what was possible. I am very happy with their website designs and digital marketing which are bringing great results so far! Great team to work with.",
    stars: 5,
  },
  {
    username: "Kevin Perdigues",
    text: "Very good quality-price ratio. Jude is fair and his team are magicians of the web! Great team to work with. They've worked hard to pull off a fantastic result beyond my expectations. Excellent work ethic and engagement. Highly recommend their services.",
    stars: 5,
  },
  {
    username: "Ayush Kokra",
    text: "Zyntics helped me with the best customization of the website alongside with the cooperative team. The developers know what they are doing, I am very satisfied with my website as the developers are also knowledgeable about work and the field. I got no chance of complaints against them.",
    stars: 5,
  },
];
